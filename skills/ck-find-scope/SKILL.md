...
.claude/skills/ck/ck find-scope \
...
**Mac / Linux:**
```bash
.claude/skills/ck/ck find-scope --query "<description>" [--top <n>] [--repo <path>]
```

**Windows (PowerShell):**
```powershell
.claude\skills\ck\ck.cmd find-scope --query "<description>" [--top <n>] [--repo <path>]
```
...
```bash
.claude/skills/ck/ck signatures <returned-folder-path>/
```
