...
```bash
# Mac / Linux
.claude/skills/ck/ck signatures src/Hosts/Api/Catalog/V1/Products/

# Windows (PowerShell)
.claude\skills\ck\ck.cmd signatures src\Hosts\Api\Catalog\V1\Products\
```
...
.claude/skills/ck/ck signatures src/**/Services/*.cs

# Windows (PowerShell)
.claude\skills\ck\ck.cmd signatures <file1.cs> [file2.cs ...]
```
...
```bash
.claude/skills/ck/ck get-method-source \
...
.claude/skills/ck/ck find-scope --query "Catalog API products controllers" --min-score 0.5
