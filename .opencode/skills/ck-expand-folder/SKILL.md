...
```bash
.opencode/skills/ck/ck expand-folder [--pattern <regex>] <folder>
```
...
.opencode/skills/ck/ck expand-folder src/Modules/Payment/Adyen/

# Filter to members mentioning "Refund"
.opencode/skills/ck/ck expand-folder --pattern "Refund" src/Modules/Payment/Adyen/

# Filter to async methods
.opencode/skills/ck/ck expand-folder --pattern "async Task" src/Modules/Payment/

# Filter to interface definitions
.opencode/skills/ck/ck expand-folder --pattern "^I[A-Z]" src/Modules/Payment/Adyen/
```
